...
SWIFT_FLAGS ?=
JOURNEY_TEST_FILTER := OperatorWorkspaceSparseTipCalibrationTests/(fullFiveMarkAcceptance|checkpointRevalidationRestoresWithoutAnotherTap|stageFourConsumesExactTipRevision)|OperatorWorkspaceTests/(boundaryRepeatActionsAggregateAndReplaceAcceptedSet|boundaryAtomicFailurePreservesAcceptedAuthority|resetBoundaryForwardRetainsEarlierLearning|resetComparisonOnlyPreservesObservedLine)|SimulatedLearningRuntimeTests/(stationaryContactMark|drawingCompletion|cooperativeBoundaryStopRaces|cooperativeBoundaryAtTruth)
