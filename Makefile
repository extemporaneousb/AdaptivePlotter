...
SWIFT_FLAGS ?=
JOURNEY_TEST_FILTER := OperatorWorkspaceTests/(simulatedLearningPathHasFullActionParity|simulatedStageFourUsesPersistentCausalInk|visibilityAttemptMutationsAreAtomic|cameraRecoveryPreservesMachineAuthorityAndStagesROIProposal|cameraChangeMakesExistingTargetUnusableWithoutRedraw|usedTargetCannotBeMadePristineByRedo|targetReturnReadinessUsesCurrentControllerFacts|observationCannotBypassClearReturnSettlement|preAcceptanceMotionHasDirectReturnRecovery|visibilityFinalMPosMismatchCannotExposeRedraw|lateVisibilityStopCanObserveButNeverRedraw|targetGeometryRedoSupersedesAllThreeRootRevisions|paperReplacementRefusalPreservesAcceptedState|registerNewTargetAreaInvalidatesAllConsumers|boundaryRepeatActionsAggregateAndReplaceAcceptedSet|boundaryAtomicFailurePreservesAcceptedAuthority)|SimulatedLearningRuntimeTests/(completeCausalLineRoute|completeCausalVisibilityRoutes)
